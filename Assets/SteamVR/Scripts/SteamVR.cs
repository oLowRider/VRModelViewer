...
public class SteamVR : System.IDisposable
{
	...
	private SteamVR()
	{
        ...
        if(hmd_TrackingSystemName == "lighthouse")
        {
            GameObject.Find("ApplicationControllers").GetComponent<ApplicationController>().ViveDetected = true;
            GameObject.Find("ApplicationControllers").GetComponent<ApplicationController>().OculusDetected = false;
            GameObject.Find("ApplicationControllers").GetComponent<ApplicationController>().NoHeadsetDetected = false;
        }
        else if (hmd_TrackingSystemName == "oculus")
        {
            GameObject.Find("ApplicationControllers").GetComponent<ApplicationController>().ViveDetected = false;
            GameObject.Find("ApplicationControllers").GetComponent<ApplicationController>().OculusDetected = true;
            GameObject.Find("ApplicationControllers").GetComponent<ApplicationController>().NoHeadsetDetected = false;
        }
        else
        {
            GameObject.Find("ApplicationControllers").GetComponent<ApplicationController>().ViveDetected = false;
            GameObject.Find("ApplicationControllers").GetComponent<ApplicationController>().OculusDetected = false;
            GameObject.Find("ApplicationControllers").GetComponent<ApplicationController>().NoHeadsetDetected = true;
        }
